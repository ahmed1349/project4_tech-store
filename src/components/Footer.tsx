      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold tech-gradient bg-clip-text text-slate-50">
              TechNest
            </h3>
            <p className="text-muted-foreground">
              {t('heroTitle')} - Your trusted partner for cutting-edge technology products.
            </p>
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              {categories.slice(0, 4).map(category => <a key={category.id} href="#" className="block text-muted-foreground hover:text-primary transition-colors">
          ...
          {/* Customer Service */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold">{t('customerService')}</h4>
            <nav className="space-y-2">
              <a href="#" className="block text-muted-foreground hover:text-primary transition-colors">
                {t('faq')}
              </a>
        ...
        <div className="border-t border-border mt-12 pt-8 text-center">
          <p className="text-muted-foreground">
            © 2024 TechNest. All rights reserved. | {t('heroTitle')}
          </p>
        </div>
      </div>
    </footer>;
